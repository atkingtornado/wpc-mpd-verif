...
const monthlyPlotOptions = [
	...
	{label: "CSI - All MPDs (YTD)", value: "barchart_no_WA_OR_20km_CSI_ALL_YTD"},
	{label: "Bias - All MPDs (YTD)", value: "barchart_no_WA_OR_20km_FRB_ALL_YTD"},
...
const multiyearPlotOptions = [
	...
	{label: "False Alarm %", value: "barchart_20km_FAR_PCT_MPD_yrs_2018"},
	...
	{label: "Frequency Bias (By Season)", value: "barchart_20km_BIAS_MPD_SEASON_yrs_2018"},
